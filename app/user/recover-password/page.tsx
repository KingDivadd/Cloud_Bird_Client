...
const RecoverPassword = () => {
    ...
    return (
        <div className="w-full bg-slate-200 h-screen flex flex-col relative items-center justify-center gap-10">
            ...
            <span className="text-2xl font-[600] flex items-center gap-[10px]">Recover <p className="text-amber-600">Password</p></span>
            <form action='' className="w-[400px] flex flex-col items-start justify-start rounded-[5px] p-[20px] bg-white  py-[30px] gap-[35px]">
            ...
            <span className="text-md font-[500] flex items-center gap-[10px] ">Already have an account? <p className="text-blue-600 cursor-pointer" onClick={()=> router.push("/user/login")}>Login</p></span>
