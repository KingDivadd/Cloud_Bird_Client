        ...
        <div className="relative w-full h-[70px] flex flex-row items-center justify-center px-[15px]">
            <div className="w-full flex flex-row items-center justify-between h-[40px] gap-[10px]">
                ...
                <span className="w-[50%] md:w-[35%] flex items-center justify-start gap-[15px]">
                    <span className="w-[35px] h-[35px] text-slate-200 cursor-pointer" onClick={toggleMenu}>
                        <BiMenu size={'100%'} />
                    </span>
                    <p className="text-lg text-slate-100 font-semibold">Dashboard</p>
                </span>
                <span className="w-[50%] md:w-[65%] flex items-center justify-end gap-[15px]">
                    <span className="h-full flex items-center justify-between gap-[10px]">
                        ...
                        <p className="hidden sm:block text-sm text-slate-200 h-[35px] bg-slate-600 flex items-center px-[20px] rounded-[35px]">
                            2 new
                        </p>
                    </span>
                    <p className="hidden md:block text-sm text-slate-200 font-normal h-[35px] my-auto flex items-center justify-center bg-slate-600 rounded-[40px] px-[20px]">
                        3 August, 2024
                    </p>
                    <span className="h-full flex items-center justify-between gap-[10px]">
                        ...
                        <span className="hidden lg:block w-[50px] flex flex-col items-between justify-end">
