            ...
            <div className="w-full flex flex-col items-start justify-start h-full gap-[15px] overflow-y-auto ">
                ...
                <div className="w-full  flex flex-col xl:flex-row items-start justify-start gap-[15px] sm:gap-[20px] pt-[10px] px-[15px] ">
                    ...
                    <div className="w-full xl:w-[77%] flex max-md:flex-col items-start justify-between gap-[15px] sm:gap-[20px] h-full   ">
                        ...
                        <div className="max-md:w-full w-1/2 h-[480px] flex flex-col items-start justify-start gap-[15px] ">
                            ...
                            <div className="w-full flex flex-col items-start justify-start h-1/3 gap-[10px] ">
                                ...
                                <div className="w-full h-full gradient-1 rounded-[7.5px] flex max-xl:flex-col items-start justify-start p-[10px]  ">
                                    
                                    <div className="w-full  xl:w-[55%] h-full flex items-start justify-start   xl:pl-[20px]  ">
                                        <span className="w-[35px] w-[35px] max-xl:mt-[2px] xl:h-[50px] xl:w-[50px] text-sky-300 "><BiDollar size={'100%'} />  </span>
                                        <p className=" text-2xl xl:text-3xl text-slate-200 xl:mt-[4px]">13,450.97</p>
                                    </div>

                                    <div className=" w-full xl:w-[45%] h-full flex flex-col items-end justify-start xl:px-[15px]   ">
                                        <p className="text-xs text-slate-300 w-full text-end  ">Compared to last month </p>
                                        <p className="text-xs text-green-500"> 36%</p>
                                    </div>
                            ...
                            <div className="w-full flex flex-col items-start justify-start h-1/3  gap-[15px] ">
                                <span className="w-full flex flex-col items-start justify-between  ">
                                ...
                                <div className="w-full h-full gradient-1 rounded-[7.5px] flex max-xl:flex-col items-start justify-start p-[10px]  ">
                                    ...
                                    <div className="w-full  xl:w-[55%] h-full flex items-start justify-start   xl:pl-[20px]  ">
                                        <span className="w-[35px] w-[35px] max-xl:mt-[2px] xl:h-[50px] xl:w-[50px] text-sky-300 "><BiDollar size={'100%'} />  </span>
                                        <p className=" text-2xl xl:text-3xl text-slate-200 xl:mt-[4px]">13,250.97</p>
                                    </div>
                            ...
                            <div className="w-full flex flex-col items-start justify-start h-1/3  ">
                                <div className="w-full h-full gradient-1 rounded-[7.5px] flex items-start justify-between ">
                                    <div className="w-[60%] h-full flex flex-col items-start justify-start pl-[30px] py-[20px] ">
                                        <p className=" max-sm:text-lg text-xl xl:text-2xl text-slate-200 w-full text-start ">Active Leads </p>
                                    </div>
                                    <div className="w-[40%] h-full flex flex-col items-end justify-start p-[10px] sm:p-[20px] gap-[20px] ">
                                        <p className=" text-2xl xl:text-3xl text-slate-200 mt-[4px]">0</p>
