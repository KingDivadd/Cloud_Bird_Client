    ...
    return (
        <div className="w-full flex flex-col items-center justify-start bg-blue-600 ">
            <nav className="w-[92.5%] mx-auto h-[120px] flex items-center justify-between ">
                {/* left nav */}
                <div className=" flex h-full items-center justify-start gap-[50px]">
                    <span className="flex items-center mr-5 cursor-pointer" onClick={()=> setHeader_nav('home') }>
                        <p className="text-xl font-bold text-white">Cloud</p>
                        <p className="text-xl font-bold text-[#04b3e4]">Bird</p>
                    </span>
                ...
                <div className=" flex h-full items-center justify-end gap-5">
                    <button className="h-[50px] text-lg font-[500] px-5 flex items-center text-slate-300 hover:text-[#04b3e4]" onClick={()=> router.push('/auth/login')}>
                        Sign in
                    </button>
                    <button className="h-[50px] font-[500] text-lg px-5 flex items-center text-slate-300 border-2 border-slate-300 hover:text-[#04b3e4] hover:border-[#04b3e4] "  onClick={handle_signup}>
                        Sign up
                    </button>
                </div>
            </nav>
            ...
            <div className="w-[70%] mx-auto flex flex-col items-start justify-start gap-5 mb-20">
                ...
                <button className="h-[60px] text-xl font-[400] border-2 border-white text-white hover:border-[#04b3e4] hover:text-[#04b3e4] rounded-[2.5px] px-5 flex items-center mt-5">
                    Get Started
                </button>
...

            {
                ...
                <div className="w-[70%] mx-auto flex  items-start justify-start gap-10 mb-20 ">
                    ...
                    <div className="flex-1 flex flex-col items-start justify-start gap-5">
                        ...
                        <p className="text-lg text-white hover:underline cursor-pointer hover:text-[#04b3e4]">support@insightEdge.com</p>
